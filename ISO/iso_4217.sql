...
CREATE TABLE IF NOT EXISTS `iso_4217` (
  ...
  `ALPHABETIC_CODE` varchar(255) NOT NULL,
...
INSERT INTO `iso_4217` (`ENTITY`, `CURRENCY`, `ALPHABETIC_CODE`, `NUMERIC_CODE`, `MINOR_UNIT`) VALUES
...
('ANTARCTICA', 'No universal currency', '', 0, 0),
...
('PALESTINE, STATE OF', 'No universal currency', '', 0, 0),
...
('SOUTH GEORGIA AND THE SOUTH SANDWICH ISLANDS', 'No universal currency', '', 0, 0),
